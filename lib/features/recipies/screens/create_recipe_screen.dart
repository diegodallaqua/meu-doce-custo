...
import 'package:meu_doce_custo/features/recipies/screens/dialogs/dialog_recipe_category.dart';
...
import '../stores/create_recipe_store.dart';
import '../stores/recipe_store.dart';
import 'recipe_screen.dart';
import 'widgets/ingredient_used_container.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if(editing)...{
                                Observer(
                                  builder: (_) {
                                    final future = createRecipeStore
                                        .ingredientsFuture;
                                    ...
                                    return FutureBuilder<List<IngredientUsed>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        final ingredients = snapshot.data ??
                                            const <IngredientUsed>[];

                                        return IngredientUsedContainer(
                                          initialIngredients: ingredients,
                                          onIngredientsChanged: createRecipeStore
                                              .updateIngredients,
                                        );
                                      },
                                    );

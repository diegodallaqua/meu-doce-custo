...
class FilterVisibleIngredient extends StatefulWidget {
  const FilterVisibleIngredient({super.key, required this.filterStore});

  final FilterSearchStore filterStore;

  @override
  State<FilterVisibleIngredient> createState() => _FilterVisibleIngredientState();
}

class _FilterVisibleIngredientState extends State<FilterVisibleIngredient> {
  //recebe uma copia do filtro que esta na HomeStore
  final FilterSearchStore filterStoreGet = GetIt.I<FilterSearchStore>();

  final IngredientStore ingredientStore = GetIt.I<IngredientStore>();
    ...
    return Observer(builder: (_) {
      return SingleChildScrollView(
        child: Column(
          ...
          children: [
            const Text(
              'Pesquise pelo Nome do Ingrediente',
              style: TextStyle(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        ingredientStore.setFilter(widget.filterStore);
